...
def get_parser():
    ...
    parser.add_argument(
        ...
        default='D:\\project_python\\SparseInst\\output_cityscapes\\2d_base_res2345_decoder_cls19_mask100\\config.yaml',
    ...
    parser.add_argument(
        ...
        default=["MODEL.WEIGHTS","D:\\project_python\\SparseInst\\output_cityscapes\\2d_base_res2345_decoder_cls19_mask100\\model_0001499.pth"],
