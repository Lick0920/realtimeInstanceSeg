        ...
        if stride != 1 or inplanes != planes * block_fn.expansion:
            ...
            if stage_idx == 0:
                ...
                downsample_2 = downsample_avg_3d_channel(
                    **down_3d_kwargs) if avg_down else downsample_conv_3d_channel(**down_3d_kwargs) # 步长 222 
...
def build_resnet_vd3d_down4x4_backbone(cfg, input_shape):
    ...
    stage_blocks = []
    use_deformable = cfg.MODEL.RESNETS.DEFORM_ON_PER_STAGE # [2, 3, True, True]
    for idx in range(4):
...
if __name__ == '__main__':
    ...
    args.config_file = 'D:\\project_python\\SparseInst\\configs\\3d_test\\3d_2k3k_4x4.yaml'
