...
class Bottleneck_3d_down(nn.Module):
    ...
    def __init__(
        ...
        # self.bn1 = norm_layer(first_planes)
        # self.act1 = act_layer(inplace=True)
        self.conv1 = nn.Conv3d(inplanes, first_planes, kernel_size=1,stride=(2,1,1), bias=False)
        self.bn1 = nn.BatchNorm3d(first_planes)
        self.act1 = act_layer(inplace=True)
        ...
        self.conv3 = nn.Conv3d(width, outplanes, kernel_size=1, stride=(2,1,1),bias=False)
        self.bn3 = nn.BatchNorm3d(outplanes)
...
def build_resnet_vd3d_down_large_backbone(cfg, input_shape):
...
if __name__ == '__main__':
    ...
    args.config_file = 'D:\\project_python\\SparseInst\\configs\\3d_test\\resnet3d_notdep_.yaml'
