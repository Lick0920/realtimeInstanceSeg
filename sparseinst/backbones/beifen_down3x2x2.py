...
class ResNet(Backbone):
    def __init__(self, block_types, layers, in_chans=3,
        ...
        # 字典添加一个 lck 0412
        self._out_feature_channels["conv1_spd"] = 4096
        ...
        self.spd_branch = nn.Sequential(*layer_branchspd)
...
if __name__ == '__main__':
    ...
    args.config_file = 'D:\\project_python\\SparseInst\\configs\\3d_test\\333d_3x2x2_down.yaml'
