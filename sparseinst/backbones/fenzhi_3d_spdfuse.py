...
def build_resnet_vd_backbone_2d_solo(cfg, input_shape):
...
if __name__ == '__main__':
    ...
    args.config_file = 'D:\project_python\SparseInst\configs\\fenzhi\\2d_solo.yaml.yaml'
